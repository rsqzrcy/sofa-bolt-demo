...
public interface RejectionProcessableInvokeCallback extends InvokeCallback {
    ...
    /**
     * when user executor rejected the {@link com.mfma.sofaboltdemo.sofabolt.rpc.RpcInvokeCallbackListener.CallbackTask},
     * bolt will handle the rejected task according to this {@link RejectedExecutionPolicy}
     * @return rejectedExecution Policy
     * @see com.mfma.sofaboltdemo.sofabolt.rpc.RpcInvokeCallbackListener#onResponse(InvokeFuture)
     */
