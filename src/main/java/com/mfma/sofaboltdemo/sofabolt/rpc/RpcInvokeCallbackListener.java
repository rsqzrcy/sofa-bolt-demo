...
public class RpcInvokeCallbackListener implements InvokeCallbackListener {
    ...
    /**
     * @see com.mfma.sofaboltdemo.sofabolt.InvokeCallbackListener#onResponse(com.mfma.sofaboltdemo.sofabolt.InvokeFuture)
     */
    @Override
    ...
    /**
     * @see com.mfma.sofaboltdemo.sofabolt.InvokeCallbackListener#getRemoteAddress()
     */
    @Override
