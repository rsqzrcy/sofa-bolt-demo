...
import com.mfma.sofaboltdemo.sofabolt.BaseRemoting;
...
public abstract class RpcRemoting extends BaseRemoting {
    ...
    /**
     * @see com.mfma.sofaboltdemo.sofabolt.BaseRemoting#createInvokeFuture(com.mfma.sofaboltdemo.sofabolt.RemotingCommand, com.mfma.sofaboltdemo.sofabolt.InvokeContext)
     */
    @Override
    ...
    /**
     * @see com.mfma.sofaboltdemo.sofabolt.BaseRemoting#createInvokeFuture(Connection, RemotingCommand, InvokeContext, InvokeCallback)
     */
    @Override
