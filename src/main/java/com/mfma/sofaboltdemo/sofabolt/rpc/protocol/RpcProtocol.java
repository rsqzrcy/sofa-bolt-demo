...
import com.mfma.sofaboltdemo.protocol.decoder.BizCommandDecoder;
import com.mfma.sofaboltdemo.sofabolt.*;
import com.mfma.sofaboltdemo.sofabolt.rpc.RpcCommandFactory;
...
public class RpcProtocol implements Protocol {
     ...
     * 协议版本
     */
    public static final String PROTOCOL_VERSION  = "0300";
    ...
    public RpcProtocol() {
        ...
        this.decoder = new BizCommandDecoder();
