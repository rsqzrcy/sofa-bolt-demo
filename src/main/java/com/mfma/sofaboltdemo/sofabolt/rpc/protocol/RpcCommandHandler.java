...
public class RpcCommandHandler implements CommandHandler {
        ...
        try {
            if (msg instanceof List) {
                ...
                if (RpcConfigManager.dispatch_msg_list_in_default_executor()) {
                    ...
                    // See com.mfma.sofaboltdemo.remoting.decoder.ProtocolDecoder
    ...
    /**
     * @see CommandHandler#registerProcessor(com.mfma.sofaboltdemo.sofabolt.CommandCode, RemotingProcessor)
     */
    @Override
