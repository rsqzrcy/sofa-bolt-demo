...
public class BoltLoggerFactory {
    ...
    private static String       BOLT_LOG_SPACE            = "com.mfma.sofaboltdemo.remoting";
    ...
    private static final String LOG_PATH_DEFAULT          = System.getProperty("user.home")
                                                            + File.separator + "logs";
    private static final String CLIENT_LOG_LEVEL          = "com.mfma.sofaboltdemo.remoting.client.log.level";
    private static final String CLIENT_LOG_LEVEL_DEFAULT  = "INFO";
    private static final String CLIENT_LOG_ENCODE         = "com.mfma.sofaboltdemo.remoting.client.log.encode";
