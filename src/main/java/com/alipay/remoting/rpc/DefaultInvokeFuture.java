...
public class DefaultInvokeFuture implements InvokeFuture {
	 ...
	 */
	public DefaultInvokeFuture(int invokeId, InvokeCallbackListener callbackListener, InvokeCallback callback, ProtocolCode protocolCode, CommandFactory commandFactory) {
	 ...
	 */
	public DefaultInvokeFuture(int invokeId, InvokeCallbackListener callbackListener, InvokeCallback callback, ProtocolCode protocolCode, CommandFactory commandFactory, InvokeContext invokeContext) {
	...
	/**
	 * @see InvokeFuture#putResponse(RemotingCommand)
	 */
	@Override
	...
	/**
	 * @see InvokeFuture#getInvokeCallback()
	 */
	@Override
	...
	/**
	 * @see InvokeFuture#addTimeout(io.netty.util.Timeout)
	 */
	@Override
	...
	/**
	 * @see InvokeFuture#cancelTimeout()
	 */
	@Override
	...
	/**
	 * @see InvokeFuture#setCause(java.lang.Throwable)
	 */
	@Override
	...
	/**
	 * @see InvokeFuture#getProtocolCode()
	 */
	@Override
	...
	/**
	 * @see InvokeFuture#tryAsyncExecuteInvokeCallbackAbnormally()
	 */
	@Override
		...
		try {
			...
			if (null != protocol) {
				...
				if (null != commandHandler) {
					...
					logger.error("Executor null in commandHandler of protocolCode [{}].", this.protocolCode.toString());
				}
			} else {
