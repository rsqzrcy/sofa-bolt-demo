 ...
 * , {@link #RpcServer(int, boolean)}, {@link #RpcServer(int, boolean, boolean)}
...
public class RpcServer extends AbstractRemotingServer {
	...
	private JSONObject protocolParams;
	 ...
	 * Otherwise {@link UnsupportedOperationException} will be thrown.
	 */
	public RpcServer(int port, JSONObject protocolParams) {
		this(port, false);
	...
	protected void doInit() {
		...
		ProtocolCode protocolCode = this.protocolParams.getObject("ProtocolCode", ProtocolCode.class);
		RpcProtocol protocol = this.protocolParams.getObject("Protocol", RpcProtocol.class);
		RpcProtocolManager.initProtocols(protocol, protocolCode);
		initRpcRemoting();
		...
		ProtocolDecoder protocolDecoder = this.protocolParams.getObject("ProtocolDecoder", ProtocolDecoder.class);
		...
		this.bootstrap.childHandler(new ChannelInitializer<SocketChannel>() {
			...
			protected void initChannel(SocketChannel channel) {
				...
				pipeline.addLast("decoder", protocolDecoder);
	...
	/**
	 * @see RemotingServer#registerProcessor(JSONObject protocolCode, CommandCode, RemotingProcessor)
	 */
	@Override
