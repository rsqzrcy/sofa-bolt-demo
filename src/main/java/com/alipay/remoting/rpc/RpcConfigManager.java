...
public class RpcConfigManager {
	...
	public static String server_ssl_kmf_algorithm() {
		return ConfigManager.getString(RpcConfigs.SRV_SSL_KMF_ALGO, KeyManagerFactory.getDefaultAlgorithm());
	}
	...
	public static String client_ssl_tmf_algorithm() {
		return ConfigManager.getString(RpcConfigs.CLI_SSL_TMF_ALGO, TrustManagerFactory.getDefaultAlgorithm());
	}
}
